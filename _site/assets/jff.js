...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'jff.wast';
  var wasmBinaryFile = 'jff.wasm';
  var asmjsCodeFile = 'jff.temp.asm.js';
...
var ASM_CONSTS = [function($0) { picture.style.transform = "rotate(" + $0 + "deg)" }];
...
var real__binarify = asm["_binarify"]; asm["_binarify"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__binarify.apply(null, arguments);
};
...
var real__frame = asm["_frame"]; asm["_frame"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
...
var _binarify = Module["_binarify"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_binarify"].apply(null, arguments) };
...
var _frame = Module["_frame"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_frame"].apply(null, arguments) };
