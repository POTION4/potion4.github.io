...
if (!ENVIRONMENT_IS_PTHREAD) addOnPreRun(function() { if (typeof SharedArrayBuffer !== 'undefined') { addRunDependency('pthreads'); PThread.allocateUnusedWorkers(3, function() { removeRunDependency('pthreads'); }); }});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'threads.wast';
  var wasmBinaryFile = 'threads.wasm';
  var asmjsCodeFile = 'threads.temp.asm.js';
...
/* global initializers */ if (!ENVIRONMENT_IS_PTHREAD) __ATINIT__.push({ func: function() { __GLOBAL__I_000101() } }, { func: function() { ___emscripten_pthread_data_constructor() } }, { func: function() { __GLOBAL__sub_I_iostream_cpp() } });


if (!ENVIRONMENT_IS_PTHREAD) {
memoryInitializer = "threads.js.mem";
}
...
// {{PRE_LIBRARY}}
  ...
  function ___syscall91(which, varargs) {if (ENVIRONMENT_IS_PTHREAD) { return _emscripten_sync_run_in_main_thread_2(621805568, 91, varargs) }
  SYSCALLS.varargs = varargs;
  try {
   // munmap
...
var proxiedFunctionTable = [null,_emscripten_get_canvas_element_size_main_thread,_emscripten_set_canvas_element_size_main_thread,_getenv];
...
var real___Z5startv = asm["__Z5startv"]; asm["__Z5startv"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___Z5startv.apply(null, arguments);
};
...
var __Z5startv = Module["__Z5startv"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__Z5startv"].apply(null, arguments) };
